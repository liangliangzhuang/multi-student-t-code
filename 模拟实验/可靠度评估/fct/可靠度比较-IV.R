...
NL_Wiener_MTTF = NL_T_MTTF = true_MTTF = numeric()
...
for(qqq in 1:itt){
  ...
  # 估计的相关系数计算（公式4）=======
  opt_para = em_re_nolinear_T$para  #估计值保存
...
# save.image(file = paste("模拟实验/可靠度评估/result/IV-n",n,"-m",m,".RData", sep = ""))
